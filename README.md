...
- [ ] Лолжна быть ссылка на гугл колаб, в котором через # и ## есть следующие разделы и подразделы:
    - [ ] Пароль
        - [ ] 
    - [ ] Аналитика данных
        - [ ] Есть задание и диаграмма
        - [ ] Есть ссылки на все файлы, в сводной таблице есть формулы Excel
        - [ ] Есть 3 способа загрузки файлов
        - [ ] Есть код, который создаеьт сводную таблицу и вы ответили по нему на вопросы 
- [ ] 
