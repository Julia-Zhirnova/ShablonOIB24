...
- [ ] Ссылка на гугл колаб, в котором через # и ## есть следующие разделы и подразделы:
    ...
    - [ ] Якласс
        ...
        - [ ] Добавить скрины всех выполненных работ
              <img src="https://github.com/user-attachments/assets/7cb442d3-1c6f-4d39-afe2-c31a3ae46cf3" alt="Пример скрина работы" height="100" />
    - [ ] Пароль
        - [ ] Задание и блок-схема
